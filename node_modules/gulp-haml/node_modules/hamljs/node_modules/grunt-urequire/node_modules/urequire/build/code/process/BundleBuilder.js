...
var Build, Bundle, BundleBuilder, UError, VERSION, blendConfigs, fs, l, upath, _, _B,
...
BundleBuilder = (function() {
  ...
  function BundleBuilder(configs, deriveLoader) {
    ...
    this.config = blendConfigs(_.flatten(configs), deriveLoader, true);
