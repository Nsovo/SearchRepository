...
module.exports = MasterDefaultsConfig = {
  bundle: {
    ...
    dependencies: {
      ...
      node: ['fs', 'events', 'util', 'http', 'path', 'child_process', 'events', 'crypto', 'string_decoder', 'timers', 'tls', 'domain', 'buffer', 'net', 'dgram', 'dns', 'stream', 'https', 'querystring', 'punycode', 'readline', 'url', 'repl', 'vm', 'assert', 'tty', 'zlib', 'os', 'cluster', 'console', 'freelist', 'sys', 'constants'],
      locals: {},
      depsVars: {},
      _knownDepsVars: {
        chai: 'chai',
