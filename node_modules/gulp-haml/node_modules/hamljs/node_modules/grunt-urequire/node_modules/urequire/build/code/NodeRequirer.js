...
NodeRequirer = (function(_super) {
  ...
  NodeRequirer.prototype.loadModule = function(dep) {
    var att, attIdx, attempts, err, loadedModule, modulePath, resolvedPathNo, resolvedPaths, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
    attempts = [];
    ...
    for (resolvedPathNo = _i = 0, _len = resolvedPaths.length; _i < _len; resolvedPathNo = ++_i) {
      ...
      if (loadedModule === unloaded) {
        if ((_ref = (_ref1 = dep.plugin) != null ? typeof _ref1.name === "function" ? _ref1.name() : void 0 : void 0) === (void 0) || _ref === 'node') {
          if (l.deb(95)) {
    ...
    if (loadedModule === unloaded) {
      ...
      throw ((_ref8 = attempts[0]) != null ? (_ref9 = _ref8.error) != null ? _ref9.err : void 0 : void 0) || '1st err was undefined!';
    } else {
      return loadedModule;
    }
  };
