...
Bundle = (function(_super) {
  ...
  Bundle.calcProperties = {
    ...
    copyBundleFiles: function() {
      if (_.isEmpty(this.copy)) {
        ...
        return _.pick(this.files, (function(_this) {
    ...
    all_depsVars: function() {
      return this.inferEmptyDepVars(this.getDepsVars(), 'Gathering @all_depsVars & infering empty depVars', false);
    },
  ...
  Bundle.prototype.inferEmptyDepVars = function(depVars, whyMessage, throwOnMissing) {
  ...
  Bundle.prototype.combine = function() {
    ...
    rjsConfig = {
      ...
      include: [this.main],
      deps: _.union(_.keys(this.nodeOnly_depsVars), _.keys(combinedTemplate.exportsBundle_bundle_depsVars)),
    ...
    return this.requirejs.optimize(rjsConfig, (function(_this) {
