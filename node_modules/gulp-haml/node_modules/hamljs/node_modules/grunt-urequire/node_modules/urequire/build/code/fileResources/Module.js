...
var Dependency, Module, ModuleGeneratorTemplates, TextResource, UError, fs, isEqualCode, isLikeCode, isTrueOrFileInSpecs, l, replaceCode, toAST, toCode, upath, util, _, _B,
...
Module = (function(_super) {
  ...
  Object.defineProperties(Module.prototype, {
    dstPath: {
      get: function() {
        var _ref, _ref1;
        if ((_ref = this.bundle) != null ? _ref.build.template._combinedFileTemp : void 0) {
          return this.bundle.build.template._combinedFileTemp;
        } else {
          if ((_ref1 = this.bundle) != null ? _ref1.build.dstPath : void 0) {
  ...
  _ref = ['useStrict', 'bare', 'globalWindow', 'runtimeInfo', 'noRootExports', 'allNodeRequires', 'dummyParams', 'scanAllow', 'injectExportsModule', 'noLoaderUMD', 'warnNoLoaderUMD'];
  _fn = function(bof) {
    return Object.defineProperty(Module.prototype, 'is' + _.capitalize(bof), {
      get: function() {
        var _ref1, _ref2;
        return isTrueOrFileInSpecs((_ref1 = this.bundle) != null ? (_ref2 = _ref1.build) != null ? _ref2[bof] : void 0 : void 0, this.path);
      }
    });
  };
  ...
  Module.prototype.resetModuleInfo = function() {
    var dv, _j, _len1, _ref1;
    this.flags = {};
    _ref1 = this.keys_extractedDepsAndVarsArrays;
  ...
  Module.prototype.info = function() {
    var info, p, _j, _len1, _ref1;
    info = {};
    _ref1 = _.flatten([this.keys_extractedDepsAndVarsArrays, this.keys_resolvedDependencies, ['flags', 'name', 'kind', 'path', 'factoryBody', 'preDefineIIFEBody', 'parameters']]);
    for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
      p = _ref1[_j];
      if (!_.isEmpty(this[p])) {
        if (_.isArray(this[p])) {
  ...
  Module.prototype.readArrayDepsAndVars = function(arrayAst, arrayDeps, paramsAst, factoryParams) {
    var arrayDep, astArrayDep, excParamIdx, idx, param, _j, _k, _len1, _ref1, _ref2, _ref3, _ref4, _ref5;
    ...
    for (excParamIdx = _k = _ref3 = arrayAst.elements.length, _ref4 = paramsAst.length - 1; _k <= _ref4; excParamIdx = _k += 1) {
  ...
  Module.prototype.extract = function() {
    var AMDSignature, args, bodyNode, define, defines, err, i, idx, _j, _k, _len1, _ref1, _ref2;
    if (l.deb(70)) {
    ...
    if (defines.length === 1) {
      ...
      for (i = _k = 0, _ref2 = args.length - 1; 0 <= _ref2 ? _k <= _ref2 : _k >= _ref2; i = 0 <= _ref2 ? ++_k : --_k) {
  ...
  Module.prototype.prepare = function() {
    var ar1, ar2, dep, lenDiff, pi, _j, _ref1;
    if (l.deb(70)) {
      l.debug("@prepare for '" + this.srcFilename + "'\n");
    }
    this.parameters = this.ext_defineArrayDeps.length === 0 ? [] : this.ext_defineFactoryParams.slice(0, +(this.ext_defineArrayDeps.length - 1) + 1 || 9e9);
    ...
    this.defineArrayDeps = (function() {
      ...
      _ref1 = this.ext_defineArrayDeps;
      _results = [];
  ...
  Module.prototype.adjust = function(build) {
    var addToArrayDependencies, newDep, oldDep, oldDeps, reqDep, rootExports, rt, _base, _j, _k, _l, _len1, _len2, _len3, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
    this.build = build;
    if (l.deb(70)) {
      l.debug("\n@adjust for '" + this.srcFilename + "'");
    }
    if (((_ref1 = this.build) != null ? (_ref2 = _ref1.template) != null ? _ref2.name : void 0 : void 0) !== 'combined') {
      this.injectDeps((_ref3 = this.bundle) != null ? (_ref4 = _ref3.dependencies) != null ? (_ref5 = _ref4.exports) != null ? _ref5.bundle : void 0 : void 0 : void 0);
    }
    if (this.flags.rootExports) {
      this.flags.rootExports = _B.arrayize(this.flags.rootExports);
    }
    if (rootExports = (_ref6 = this.bundle) != null ? (_ref7 = _ref6.dependencies) != null ? (_ref8 = _ref7.exports) != null ? (_ref9 = _ref8.root) != null ? _ref9[this.path] : void 0 : void 0 : void 0 : void 0) {
      _ref10 = _B.arrayize(rootExports);
    ...
    this.webRootMap = ((_ref11 = this.bundle) != null ? _ref11.webRootMap : void 0) || '.';
    addToArrayDependencies = (function(_this) {
      return function(reqDep) {
        var foundDeps, rl, _k, _len2, _ref12, _results;
        if (!reqDep.isNode) {
          ...
          if (_.isEmpty(foundDeps)) {
            ...
            _ref12 = reqDep.AST_requireLiterals || [];
            _results = [];
    ...
    _ref15 = ((_ref13 = this.bundle) != null ? (_ref14 = _ref13.dependencies) != null ? _ref14.replace : void 0 : void 0) || {};
    for (newDep in _ref15) {
      oldDeps = _ref15[newDep];
  ...
  Module.prototype.updateRequireLiteralASTs = function() {
    var dep, _j, _len1, _ref1, _results;
  ...
  Module.prototype.injectDeps = function(depVars) {
    var dep, depName, dependenciesBindingsBlender, varName, varNames, _j, _len1, _ref1;
    if (l.deb(40)) {
  ...
  Module.prototype.replaceDep = function(matchDep, newDep, options) {
    var debugHead, dep, depIdx, depName, err, isMatch, rai, removeArrayIdxs, updDep, _j, _k, _len1, _ref1;
    if (options == null) {
      options = {};
    }
    if (l.deb(70)) {
    ...
    removeArrayIdxs = [];
    _ref1 = this.defineArrayDeps || [];
    for (depIdx = _j = 0, _len1 = _ref1.length; _j < _len1; depIdx = ++_j) {
      dep = _ref1[depIdx];
  ...
  Module.prototype.getDepsVars = function(depFltr) {
    var bundleRelativeDep, dep, depVarArrays, depsArrayName, dv, idx, varNames, varsArrayName, _j, _len1, _ref1, _ref2;
    if (depFltr == null) {
      depFltr = function() {
        return true;
      };
  ...
  Module.prototype.addReportData = function() {
    var dep, _j, _len1, _ref1, _ref2, _ref3, _results;
    _ref1 = _.flatten([
  ...
  Object.defineProperties(Module.prototype, {
    nodeDeps: {
      get: function() {
        var nds, remainingDep, _j, _len1, _ref1, _ref2, _ref3, _ref4, _ref5;
        if (this.isAllNodeRequires) {
          return this.defineArrayDeps;
        } else {
          if (!((_ref1 = this.parameters) != null ? _ref1.length : void 0)) {
            nds = [];
          } else {
            nds = ((_ref2 = this.defineArrayDeps) != null ? _ref2.slice(0, +(((_ref3 = this.parameters) != null ? _ref3.length : void 0) - 1) + 1 || 9e9) : void 0) || [];
          }
          if (this.defineArrayDeps) {
            _ref5 = this.defineArrayDeps.slice((_ref4 = this.parameters) != null ? _ref4.length : void 0, +(this.defineArrayDeps.length - 1) + 1 || 9e9);
            for (_j = 0, _len1 = _ref5.length; _j < _len1; _j++) {
              remainingDep = _ref5[_j];
