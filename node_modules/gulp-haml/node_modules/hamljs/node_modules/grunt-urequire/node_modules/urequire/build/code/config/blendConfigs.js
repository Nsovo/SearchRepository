...
bundleBuildBlender = new _B.DeepCloneBlender([
  {
    ...
    arrayizeConcat: function(prop, src, dst) {
      if (_.isFunction(src[prop])) {
        ...
        return arrayizePusher.blend(dst[prop], _.clone(src[prop]));
      }
    },
    arraysConcatOrOverwrite: function(prop, src, dst) {
      if (_.isFunction(src[prop])) {
        ...
        if (_.isArray(dst[prop]) && _.isArray(src[prop])) {
          return arrayizePusher.blend(_.clone(dst[prop]), src[prop]);
        } else {
          return src[prop];
        }
      }
...
blendConfigs = function(configsArray, deriveLoader, withMaster) {
  var finalCfg, idx, rc, resourceConverter, resources, _i, _len, _ref;
  if (withMaster == null) {
    withMaster = false;
  }
  if (withMaster) {
  ...
  if (!_.isEmpty(finalCfg.bundle.resources)) {
    resources = [];
    _ref = finalCfg.bundle.resources;
    for (idx = _i = 0, _len = _ref.length; _i < _len; idx = ++_i) {
      resourceConverter = _ref[idx];
