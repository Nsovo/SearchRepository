...
module.exports = AlmondOptimizationTemplate = (function(_super) {
  ...
  function AlmondOptimizationTemplate(bundle) {
    ...
    this.exportsBundle_bundle_depsVars = _.pick(this.bundle.exportsBundle_depsVars, function(vars, dep) {
      return (new Dependency(dep, {
        path: '__rootOfBundle__',
        bundle: _this.bundle
      })).isBundle;
    });
    this.local_nonExportsBundle_depsVars = _.pick(this.bundle.localNonNode_depsVars, function(vars, dep) {
