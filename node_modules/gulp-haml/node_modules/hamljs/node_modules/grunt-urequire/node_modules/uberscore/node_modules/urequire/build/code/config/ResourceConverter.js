...
ResourceConverter = (function() {
  ...
  ResourceConverter.prototype.update = function(rc) {
    ...
    if (rc !== this) {
      ...
      if (this.isAfterOptimize == null) {
        this.isAfterOptimize = false;
      }
    }
    if (((_ref = this.type) === 'file' || _ref === 'text' || _ref === 'bundle') && (this.isBeforeTemplate || this.isAfterTemplate || this.isAfterOptimize)) {
      throw new UError("RC with name: '" + this.name + "': you should NOT have a non-module RC with any of @isBeforeTemplate or @isAfterTemplate or @isAfterOptimize");
    }
    return this;
  };
  ...
  nameFlagsActions = {
    ...
    '%': function(rc) {
      return rc.isAfterOptimize = true;
    }
  };
