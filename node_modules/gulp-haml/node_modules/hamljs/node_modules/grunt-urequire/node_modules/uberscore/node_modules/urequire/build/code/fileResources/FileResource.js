...
var BundleFile, FileResource, ResourceConverterError, UError, fs, l, mkdirp, upath, _, _B, _ref,
...
FileResource = (function(_super) {
  ...
  */
  ...
  FileResource.prototype.runResourceConverters = function(convFilter) {
    var err, oldDstFn, resConv, _i, _len, _ref1, _ref2, _ref3;
    if (convFilter == null) {
      convFilter = function() {
        return true;
      };
    ...
    for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
      ...
      if (l.deb(40)) {
        l.deb(40, ("ResourceConverter '" + resConv.name + "' ") + ("for `" + ((_ref2 = this.constructor) != null ? _ref2.name : void 0) + "` '" + this.srcFilename + "' ") + (l.deb(70) ? " dstFn='" + this.dstFilename + "'" : ''));
      }
      try {
        ...
        err = _error;
        this.hasErrors = true;
        throw new ResourceConverterError("Error converting " + ((_ref3 = this.constructor) != null ? _ref3.name : void 0) + " '" + this.srcFilename + "' with ResourceConverter '" + (resConv != null ? resConv.name : void 0) + "':", {
          nested: err
        });
      }
