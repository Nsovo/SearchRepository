...
var Dependency, MasterDefaultsConfig, isFileInSpecs, l, minimatch, pathRelative, untrust, upath, util, _, _B,
  ...
  */
  ...
  Object.defineProperties(Dependency.prototype, {
    ...
    _fileRelative: {
      get: function() {
        var ret, _ref, _ref1;
        ret = this.untrusted ? this._depString : ((_ref = this.module) != null ? _ref.path : void 0) && this.isFound ? pathRelative(upath.dirname(((_ref1 = this.module) != null ? _ref1.path : void 0) || '__root__'), this._bundleRelative, {
          dot4Current: true,
          assumeRoot: true
        }) : upath.normalizeSafe(this.resourceName);
        return ret;
      }
    },
    _isBundleBoundary: {
  ...
  Dependency.prototype.name = function(options) {
    ...
    if (this.untrusted) {
      ...
      return (options.quote ? "'" : '') + (options.plugin && this.plugin && !this.isNode ? this.plugin.name() + '!' : '') + (options.relative === 'bundle' ? this._bundleRelative : this._fileRelative) + (options.ext === false || !this.extname ? '' : this.extname) + (options.quote ? "'" : '');
    }
  };
