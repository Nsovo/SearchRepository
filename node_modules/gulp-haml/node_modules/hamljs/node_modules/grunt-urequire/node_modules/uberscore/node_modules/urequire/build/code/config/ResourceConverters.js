...
var ResourceConverter, defaultResourceConverters, extraResourceConverters, l, wrapCoffeeDefineCommonJS, _, _B;
...
defaultResourceConverters = [
  {
    ...
    '$coffee-script', "Coffeescript compiler, using locally installed 'coffee-script'.", ['**/*.coffee', /.*\.(coffee\.md|litcoffee)$/i], function(m) {
      var coffee;
      coffee = require('coffee-script');
      return coffee.compile(m.converted);
    }, function(srcFn) {
    ...
    '$LiveScript', ['**/*.ls'], function(m) {
      return (require('LiveScript')).compile(m.converted);
    }, '.js'
  ], [
    '$iced-coffee-script', ['**/*.iced'], (function(r) {
      return require('iced-coffee-script').compile(r.converted);
    }), '.js'
  ], [
    '$coco', ['**/*.co'], (function(r) {
      return require('coco').compile(r.converted);
    }), '.js'
  ]
];
...
defaultResourceConverters.unshift(wrapCoffeeDefineCommonJS = new ResourceConverter([
  'wrapCoffeeDefineCommonJS', ['**/*.coffee', '**/*.co', '**/*.ls', '**.iced'], function(r) {
